...
В ходе экспериментального исследования модель была обучена на видеопоследовательностях русского дактильного алфавита и продемонстрировала высокую устойчивость распознавания в режиме реального времени.

| Метрика | Значение |
|---------|----------|
| **Training Accuracy** | **0.96** |
| **Validation Accuracy** | **0.91** |
| **Loss Reduction** | **Стабильное снижение** |
